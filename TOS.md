...
Some jurisdictions do not allow the exclusion of certain warranties or the limitation of liability for gross negligence, willful misconduct, or personal injury. In those jurisdictions, the above exclusions apply only to the fullest extent permitted by law.
...
* **Content.** All prompts you submit and all output you receive, store, publish, or distribute.
* **Your data.** Local chat history, settings, and backups. RouterChat provides no backup or recovery service.
...
RouterChat contains no feature designed or intended to bypass provider safeguards. Any such use is unauthorized, is undertaken solely by the person performing it, and is not attributable to the author or the project.

## 5. Name, Branding, and Provider Attribution

If you modify RouterChat, or distribute a modification or fork, you must remove or replace any identifier the software sends to a provider to identify itself, including application name and referrer headers. Do not present a modified build to any provider as RouterChat.
...
To the extent permitted by applicable law, you agree to indemnify and hold harmless the author from any claim, demand, loss, liability, or expense, including reasonable attorneys' fees, arising from your use, modification, deployment, or redistribution of RouterChat, or from your violation of Section 4 or of any third party's terms of service.
...
This document may be updated. Changes apply to the version of the software distributed with them. Continued use after an update constitutes acceptance of the revised terms. 
